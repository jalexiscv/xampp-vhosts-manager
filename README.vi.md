...
* Tải về [phiên bản phát hành mới nhất](https://github.com/jalexiscv/xampp-vhosts-manager/releases/latest)
...
* Tải về [phiên bản phát hành mới nhất](https://github.com/jalexiscv/xampp-vhosts-manager/releases/latest) và giải nén nó vào thư mục ứng dụng XVHM.

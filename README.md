...
Documentation languages >>> ( English | [Vietnamese](README_vi.md) )
...
#### Via Manual Download
* Download the [latest release version](https://github.com/jalexiscv/xampp-vhosts-manager/releases/latest)
...
* Download the [latest release version](https://github.com/jalexiscv/xampp-vhosts-manager/releases/latest) and extract it into Xampp vHosts Manager application directory.
